...
@section('title')
	@section('titlename')Ask Question
@endsection
@section('content')
        ...
        <div class="question">
            <div class="col-md-12">
                <div class="row">
                	<div class="col-md-8">
	                	<div class="seper"></div>
							<form method="post" action="{{ LaravelLocalization::localizeURL('/forum/askquestion') }}" id="ask" class="form-inline" role="form">
							    {{ csrf_field() }}
							    <div class="form-group">
							        ...
							        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
							            <h5><textarea name='description' id="textareas" cols='60' rows='20'  class="s" onkeyup="countChar(this)" ></textarea><input type="file" name="image" id="upload" class="hidden" onchange=""></h5><br>  
							            <div Class="ss"></div>

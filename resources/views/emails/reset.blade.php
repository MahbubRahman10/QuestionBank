...
<body>
    ...
    <div style="background:#f9f9f9;padding: 30px 0px;">
        <div style="margin:0px auto;max-width:640px; background: white; padding: 20px 20px;">
            ...
            <p style="color: #737f8d;font-size: 16px;line-height: 24px;text-align: left;">You have requested to recover your password. Please click this link to reset your password :</p> 
            <p style="text-align: center; margin-top:40px;margin-bottom: 40px;">
                <a href='{{ url("password/resets/{$user->email_token}") }}' style="text-decoration:none;line-height:100%;background:#7289da;color:white;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:15px;font-weight:normal;text-transform:none;margin:0px; padding: 10px 10px; border-radius: 2px;font-weight: bold;">Reset Password</a>
            </p> 
            <div style="border-bottom:1px solid #dcddde;"></div>
            <!-- <p>Thank you!</p> <br>
            <p><strong>Regards,</strong></p>
            <p>Team Qbank</p> -->

            <p style="color:#4f545c;font-size: 15px;text-align: center;">Need help? <a href="http://localhost:8000/contact-us" style="font-family:Whitney,Helvetica Neue,Helvetica,Arial,Lucida Grande,sans-serif;color:#7289da" target="_blank" >Contact our support team</a> or Follow us on Twitter <a href="https://twitter.com" style="font-family:Whitney,Helvetica Neue,Helvetica,Arial,Lucida Grande,sans-serif;color:#7289da" target="_blank" >@qbank</a>.
            </p>
            <p style="margin-top: 40px;color:#4f545c;font-size: 15px;text-align: center;">Copyright ©Qbank, All rights reserved.</p>
        </div>
    </div>
</body>
</html>
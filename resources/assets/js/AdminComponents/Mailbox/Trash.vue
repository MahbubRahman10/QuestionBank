                ...
                <div class="column is-one-quarter">
                    <nav class="panel" id="panel">
                     ...
                     <!--    <div class="panel-block">
                        ...
                        <router-link :to="{name :'mailtrash'}" class="panel-block is-active">
                            <span class="panel-icon">
                        ...
                        <div class="info" v-show="showing"> 
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="msg,index in trash"  v-bind:class="[msg.Unseen == 'U' ? isActive : activeClass ]">
                                        <td>
                                        ...
                                        <td><router-link v-bind:to="'/admin/mail/trash/view/' + msg.subject.replace(/-/g, '~').replace(/ /g, '-')">{{msg.subject}}
                                        </router-link></td>
                                        <td>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            deletemsg:function() {
                this.loading = true
                axios.get('/*/admin/mail/inbox/multitrash/' + this.trash)
                .then(response => {
        ...
        mounted() {
           ...
           axios.get('/*/admin/mail/trash')
           .then(response => {
                this.trash = response.data.trash

                ...
                <div class="column is-one-quarter">
                    <nav class="panel" id="panel">
                       ...
                       <!--  <div class="panel-block">
                        ...
                        <router-link :to="{name :'maildraft'}" class="panel-block is-active">
                            <span class="panel-icon">
                ...
                <div class="column is-three-quarters" >
                    <div class="content" style="">
                        <div class="content-heading">
                            <span class=" is-left"> Draft(s) </span>
                        ...
                        <div class="info" v-show="showing">
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr v-else v-for="msg,index in draft"  v-bind:class="[msg.Unseen == 'U' ? isActive : activeClass ]">
                                        <td>
                                        ...
                                        <td><router-link v-bind:to="'/admin/mail/draft/view/' + msg.subject.replace(/-/g, '~').replace(/ /g, '-')">{{msg.subject}}
                                        </router-link></td>
                                        <td>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            deletemsg:function() {
                this.loading = true
                axios.get('/*/admin/mail/inbox/multitrash/draft/' + this.trash)
                .then(response => {

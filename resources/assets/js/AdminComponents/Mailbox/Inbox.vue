                        ...
                        <div class="info" v-show="showing" >
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr v-else v-for="msg,index in inbox"  v-bind:class="[msg.Unseen == 'U' ? isActive : activeClass ]">
                                        <td>
                                       ...
                                       <!--  <td>
                                        ...
                                        <td><router-link v-bind:to="'/admin/mail/view/' + msg.subject.replace(/-/g, '~').replace(/ /g, '-')">{{msg.subject}}
                                        </router-link></td>
                                        <td>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            deletemsg:function() {
                this.loading = true
                axios.get('/*/admin/mail/inbox/multitrash/inbox/' + this.trash)
                .then(response => {
        ...
        mounted() {
            ...
            axios.get('/*/admin/mail/inbox')
            .then(response => {
                this.inbox = response.data.inbox
                localStorage.setItem('unread',response.data.unread);

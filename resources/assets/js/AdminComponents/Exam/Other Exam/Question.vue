            ...
            <div class="columns">
                <div class="column is-one-third">
                    <nav class="panel" id="panel">
                       ...
                       <!--  <p class="panel-tabs">
                            <router-link :to="">BCS</router-link>
                            <router-link :to="{name:'ntrcaexam'}">NTRCA</router-link>
                            <router-link :to="{name:'dpeexam'}">DPE</router-link>
                            <router-link :to="{name:'bankexam'}">BANK</router-link>
                        </p> -->
                        
                        <router-link :to="{name:'bcsexam'}"class="panel-block">
                            <span class="panel-icon">
                                <i class="fa fa-book"></i>
                            </span>
                            BCS
                        </router-link>
                         <router-link :to="{name:'ntrcaexam'}"class="panel-block">
                            <span class="panel-icon">
                                <i class="fa fa-book"></i>
                            </span>
                            NTRCA
                        </router-link>
                         <router-link :to="{name:'dpeexam'}"class="panel-block">
                            <span class="panel-icon">
                                <i class="fa fa-book"></i>
                            </span>
                            DPE
                        </router-link>
                         <router-link :to="{name:'bankexam'}"class="panel-block">
                            <span class="panel-icon">
                                <i class="fa fa-book"></i>
                            </span>
                            BANK

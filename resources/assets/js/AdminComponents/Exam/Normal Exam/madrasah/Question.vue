      ...
      <div class="columns">
        <div class="column is-one-quarter">
          <nav class="panel" id="panel">
            ...
            <p class="panel-tabs">
              <router-link :to="{name:'schoolexam'}">School</router-link>
              <router-link to="" class="is-active">Madrasah</router-link>
            </p>
            <router-link :to="{name:'madrasahclass6exam'}" class="panel-block">
              <span class="panel-icon">
                <i class="fa fa-book"></i>
              </span>
              Class 6
            </router-link>
            <router-link :to="{name:'madrasahclass7exam'}"class="panel-block">
              <span class="panel-icon">
                <i class="fa fa-book"></i>
              </span>
              Class 7
            </router-link>
            <router-link :to="{name:'madrasahclass8exam'}" class="panel-block">
              <span class="panel-icon">
                <i class="fa fa-book"></i>
              </span>
              Class 8
            </router-link>
            <router-link :to="{name:'madrasahclass9exam'}" class="panel-block">
              <span class="panel-icon">
                <i class="fa fa-book"></i>
              </span>
              Class 9-10
            </router-link>
            <router-link :to="{name:'madrasahclass11exam'}" class="panel-block">
              <span class="panel-icon">
                <i class="fa fa-book"></i>
              </span>
              Class 11-12

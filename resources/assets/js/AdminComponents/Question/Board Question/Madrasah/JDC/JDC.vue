			...
			<div class="columns">
				<div class="column is-one-quarter">
					<nav class="panel" id="panel">
						...
						<p class="panel-tabs">
							<router-link to="" class="is-active">JDC</router-link>
						...
						<router-link to="" to="" class="panel-block is-active">
				...
				<div class="column" >
					<div class="content" style="background:;border:1px solid #209cee;">
						<div class="content-heading">
							<span class=" is-left"> জে ডি সি বোর্ড প্রশ্ন </span>
...
export default{
	...
	methods:{
		...
		add:function(){
			...
			var click = child.add(this.activeSubjectId, 4, this.board);
		},

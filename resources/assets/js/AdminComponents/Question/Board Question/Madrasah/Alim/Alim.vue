				...
				<div class="column is-one-quarter">
					<nav class="panel" id="panel">
						...
						<p class="panel-tabs">
							...
							<router-link to="" :to="{name:'madrasahboarddakhilquestion'}">Dakhil</router-link>
							<router-link to="" class="is-active">Alim</router-link>
						</p> -->
						<router-link :to="{name:'madrasahboardjdcquestion'}" class="panel-block">
							<span class="panel-icon">
								<i class="fa fa-book"></i>
							</span>
							JDC
						</router-link>
						<router-link :to="{name:'madrasahboarddakhilquestion'}" class="panel-block">
							<span class="panel-icon">
								<i class="fa fa-book"></i>
							</span>
							Dakhil
				...
				<div class="column" >
					<div class="content" style="background:;border:1px solid #209cee;">
						<div class="content-heading">
							<span class=" is-left"> আলিম {{subject}} বোর্ড প্রশ্ন </span>
...
export default{
	...
	methods:{
		...
		add:function(){
			...
			var click = child.add(this.activeSubjectId, 6, this.board);
		},

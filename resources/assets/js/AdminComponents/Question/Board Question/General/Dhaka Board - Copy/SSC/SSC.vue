				...
				<div class="column is-one-quarter">
					<nav class="panel" id="panel">
						...
						<p class="panel-tabs">
							...
							<router-link to="" :to="{name:'generalboardhscquestion'}">HSC</router-link>
						</p>
				...
				<div class="column" >
					<div class="content" style="background:;border:1px solid #209cee;">
						<div class="content-heading">
							<span class=" is-left"> এস এস সি {{subject}} বোর্ড প্রশ্ন </span>
...
export default{
	...
	methods:{
		...
		add:function(){
			...
			var click = child.add(this.activeSubjectId, 2, this.board);
		},

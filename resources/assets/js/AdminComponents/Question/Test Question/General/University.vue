				...
				<div class="column" >
					<div class="content" style="background:;border:1px solid #209cee;">
						<div class="content-heading">
							<span class=" is-left">  {{subject}}  </span>
...
export default{
	...
	data(){
		return{
			...
			university : this.$route.params.university, // Take University name from route
	...
	methods:{
		...
		getallsubject:function(){
			var vm = this
			axios.post('/*/admin/university/getAllsubject', { 
				id : vm.university
			})
			.then( response => { 
		...
		getquestion:function($state){
			axios.get('/*/admin/university/getquestion',{				
				params: {
		...
		add:function(){
			...
			var click = child.add(this.activeSubjectId);
		},
		...
		searchquestion:function () {
			axios.post('/*/admin/university/getsearchquestion',{
				clasubid : this.activeSubjectId,

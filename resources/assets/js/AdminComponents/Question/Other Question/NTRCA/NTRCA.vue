				...
				<div class="column is-one-quarter">
					<nav class="panel" id="panel">
						...
						<p class="panel-tabs">
                            ...
                            <router-link to="" class="is-active">NTRCA</router-link>
...
export default{
	...
	methods:{
		...
		getallsubject:function(){
			axios.post('/*/admin/question/bcs/getAllsubject', { 
				id : 12
             })
			.then( response => {  
		...
		getquestion:function($state){
			axios.get('/*/admin/question/bcs/getquestion',{				
				params: {
		...
		filterquestion:function () {
			axios.post('/*/admin/question/bcs/getfilterquestion',{
				ClsSubid : this.activeClaSubId,
		...
		searchquestion:function () {
			axios.post('/*/admin/question/bcs/getsearchquestion',{
				ClsSubid : this.activeClaSubId,

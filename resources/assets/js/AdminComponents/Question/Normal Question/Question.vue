      ...
      <div class="columns">
        <div class="column is-one-third">        
          <nav class="panel" id="panel">
            ...
            <p class="panel-tabs">
              <router-link to="" class="is-active">School</router-link>
              <router-link :to="{name:'madrasahquestion'}">Madrasah</router-link>
            </p>
            <router-link :to="{name:'class6creative'}" class="panel-block">
              <span class="panel-icon">
                <i class="fa fa-book"></i>
              </span>
              Class 6
            </router-link>
            <router-link :to="{name:'class7creative'}"class="panel-block">
              <span class="panel-icon">
                <i class="fa fa-book"></i>
              </span>
              Class 7
            </router-link>
            <router-link :to="{name:'class8creative'}" class="panel-block">
              <span class="panel-icon">
                <i class="fa fa-book"></i>
              </span>
              Class 8
            </router-link>
            <router-link :to="{name:'class9creative'}" class="panel-block">
              <span class="panel-icon">
                <i class="fa fa-book"></i>
              </span>
              Class 9-10
            </router-link>
          <!--   <router-link :to="{name:'class11creative'}" class="panel-block">
              <span class="panel-icon">
                <i class="fa fa-book"></i>
              </span>
              Class 11-12
...
export default{
  ...
  methods:{
    ...
    getdata:function(){
      axios.get('/*/admin/questiondata/school')
      .then( response => {  

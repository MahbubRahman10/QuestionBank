			...
			<div class="columns">
				<div class="column is-one-quarter">
					<nav class="panel" id="panel">
						...
						<p class="panel-tabs">
							<router-link :to="{name:'madrasahclass7creative'}">Creative</router-link>
...
export default{
	...
	methods:{
		...
		getquestion:function(value){
			...
			axios.post('/*/admin/question/mcq/getquestion',{
		...
		filterquestion:function () {
			axios.post('/*/admin/question/mcq/getfilterquestion',{
				ClsSubid : this.activeClaSubId,
				secid : this.fid,
		...
		searchquestion:function () {
			axios.post('/*/admin/question/mcq/getsearchquestion',{
				ClsSubid : this.activeClaSubId,
				secid : this.fid,

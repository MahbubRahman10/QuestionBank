				...
				<div class="column" >
					<div class="content" style="background:;border:1px solid #209cee;">
						<div class="content-heading">
							<span class=" is-left" v-if="solve == 'teacher'">  Teacher Requirement Archive  </span>
							<span class=" is-left" v-if="solve == 'university'">  University Admission Test Archive  </span>
							<span class=" is-left" v-if="solve == 'bank'">  Bank Requirement Archive  </span>
							<span class=" is-left" v-if="solve == 'bcs'">  BCS Question Archive  </span>
							...
							<table>
								...
								<tbody>
									...
									<tr v-else v-for="(question,index) in questions">
										...
										<td>{{ question.year }}</td>
										<td> <a :href="'http://localhost:8000/SolutionQuestion/'+question.file">{{ question.file }}</a> </td>
										<td>
...
export default{
	...
	data(){
		return{
			...
			solve : this.$route.params.solve, // Take University name from route
	...
	methods:{
		...
		getquestion:function($state){
			axios.get('/*/admin/questionsolve/getquestion',{				
				params: {
					category : this.solve,
		...
		add:function(){
			...
			var click = child.add(this.solve);
		},
		...
		filterquestion:function () {
			axios.post('/*/admin/questionsolve/getfilterquestion',{
				category : this.solve,
		...
		searchquestion:function () {
			axios.post('/*/admin/questionsolve/getsearchquestion',{
				category : this.solve,

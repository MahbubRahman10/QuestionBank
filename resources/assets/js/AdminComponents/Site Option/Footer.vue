					...
					<div class="content-body">
						<table>
							<tr>
								...
								<td class="from-input">
									<div :class="{ 'has-error': errors.has('copyright') }">
										<input v-validate="'required'" type="text" v-model="copyright" name="copyright" class="input"><br>
										<span v-show="errors.has('copyright')">{{ errors.first('copyright') }}</span>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="from-input">
									<div :class="{ 'has-error': errors.has('description') }">
										<input v-validate="'required'" type="text" v-model="description" name="description" class="input"><br>
	...
	methods:{
		...
		getdata:function() {
			...
			.then( response => {  
				...
				this.copyright = response.data.site.copyright
				this.description = response.data.site.footerdes
				var vm = this
				setTimeout(() => {
					vm.loading = true,

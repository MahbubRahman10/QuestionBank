<template>
    <div class="error">
        ...
        <div class="wrap">
            <div class="header">
                <div class="logo">
                    <!--                        <h1><a href="https://p.w3layouts.com/demos/ohh/web/#">Ohh</a></h1> -->
                </div>
            </div>
            <div class="content">
                ...
                <a class="backhome" v-on:click="gohome">Back To Home</a>


                <div class="copy-right" style="margin-top: 30px;">
                    <p>© 2018 Qbank.All Rights Reserved</p>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        data() {
            return{
                data: 'Page not found',
                message:'You broke the balance of the internet'
            }
        },
        head:{
            title: {
